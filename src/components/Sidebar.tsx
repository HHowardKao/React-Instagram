      ...
      <div className="border-r border-gray-300 h-full mr-3  ">
        <div className="my-8 ml-3 ">
          ...
          <div className="flex items-center mb-5 mt-5">
            ...
            <h3 className="cursor-pointer">首頁</h3>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="cursor-pointer">搜尋</h3>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="cursor-pointer">探索</h3>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <img
              ...
              className="w-7 h-7 mr-3"
            />
            <h3 className="cursor-pointer">連續短片</h3>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <Link to="/chatroom">
              <h3 className="cursor-pointer">訊息</h3>
            </Link>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <svg
            ...
            <h3 className="cursor-pointer">通知</h3>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <img
              ...
              className="w-7 h-7 mr-3"
            />
            <h3 className="cursor-pointer">建立</h3>
          </div>
          <div className="flex items-center mb-5 mt-5">
            <img
        ...
        <div className="my-8 ml-3 mt-25">
          ...
          <div className="flex items-center mb-5 mt-5">
            ...
            <h3 className="cursor-pointer">更多</h3>
          </div>
        </div>
      </div>
    </>
